...
public class ConfirmationTestView extends ViewWithUiHandlers<ConfirmationTestUiHandlers> implements ConfirmationTestPresenter.MyView {
    ...
    private final ConfirmationTestActionCellFactory actionCellFactory;
    private final AsyncDataProvider<DossierProxy> dataProvider;

    @Inject
    public ConfirmationTestView(final Binder uiBinder, final SharedMessageBundle sharedMessageBundle,
    ...
    private void initDataGrid() {
        ...
        Delegate<DossierProxy> denyAction = new Delegate<DossierProxy>() {
            @Override
            public void execute(DossierProxy dossier) {
                getUiHandlers().editDenyReason(dossier);
            }
        };
        ...
        ConfirmationTestActionCell actionsCell = actionCellFactory.create(acceptAction, denyAction, previewAction);
