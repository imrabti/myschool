...
import com.gsr.myschool.server.security.AdminAuthenticationServiceImpl;
import com.gsr.myschool.server.util.SpringServiceLocator;

@Service(value = AdminAuthenticationServiceImpl.class, locator = SpringServiceLocator.class)
public interface AuthenticationRequest extends RequestContext {
    Request<AdminUserProxy> currentUser();
