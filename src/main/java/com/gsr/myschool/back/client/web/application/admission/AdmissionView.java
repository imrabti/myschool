...
import com.gsr.myschool.back.client.web.application.admission.renderer.AdmissionActionCell;
import com.gsr.myschool.back.client.web.application.admission.renderer.AdmissionActionCellFactory;
import com.gsr.myschool.back.client.web.application.admission.ui.DossierFilterEditor;
...
public class AdmissionView extends ViewWithUiHandlers<AdmissionUiHandlers> implements AdmissionPresenter.MyView {
    public interface Binder extends UiBinder<Widget, AdmissionView> {
    }
    ...
    private final AdmissionActionCellFactory actionCellFactory;
    private final AsyncDataProvider<DossierProxy> dataProvider;

    @Inject
    public AdmissionView(final Binder uiBinder, final SharedMessageBundle sharedMessageBundle,
            ...
            final UiHandlersStrategy<AdmissionUiHandlers> uiHandlers,
            final AdmissionActionCellFactory actionCellFactory) {
        super(uiHandlers);
    ...
    private void initDataGrid() {
        ...
        Delegate<DossierProxy> acceptAction = new Delegate<DossierProxy>() {
            @Override
            public void execute(DossierProxy dossier) {
                getUiHandlers().editStatusComment(dossier, true);
            }
        };

        Delegate<DossierProxy> denyAction = new Delegate<DossierProxy>() {
            @Override
            public void execute(DossierProxy dossier) {
                getUiHandlers().editStatusComment(dossier, false);
            }
        };
        ...
        AdmissionActionCell actionsCell = actionCellFactory.create(acceptAction, denyAction, previewAction);
