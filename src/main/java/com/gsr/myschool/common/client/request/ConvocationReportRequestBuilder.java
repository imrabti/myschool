...
public class ConvocationReportRequestBuilder  extends RequestBuilder {

    public ConvocationReportRequestBuilder(String url) {
        super(POST, url);
    ...
    public void sendRequest(ValueProxy data) {
        ...
        setCallback(new RequestCallback() {
            ...
            public void onResponseReceived(Request request, Response response) {
                if (GWT.isScript()) {
                    Window.open("/preinscription/resource/convocationReport?fileName=" + response.getText(), "_blank", "");
                } else {
